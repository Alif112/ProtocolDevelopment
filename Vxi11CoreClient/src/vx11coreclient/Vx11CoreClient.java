 ...
 * @author User
 */
public class Vx11CoreClient {
    public static int delayTime=500;
    public static int clientport=1024;
    ...
    static int chk;
    static Vx11Corelementation cops=new Vx11Corelementation();
...
//                    System.out.println(hexdata2);
                    ...
                    len2=cops.createPacketAtClient(newdata, offset, len);
...
//                    System.out.println(msg);
                    ...
                    len=cops.decodePacketAtClient(data, offset, is);
