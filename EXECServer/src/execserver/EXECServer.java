...
public class EXECServer {
    static int serversocketport=512;
    static Socket s;
    ...
    static EXECImplementation exec=new EXECImplementation();
...
//                br=new BufferedReader(isr);
                ...
                while(true){
                    ...
                    len=exec.decodePacket(data, offset, is);
                    if(len<0){
                        System.out.println("---------------------------------------> "+len);
                        break;
                    }
//                    String msg=Utility.bytesToHex(data, offset, len);
                    System.out.println("====received at Server============> "+len);
