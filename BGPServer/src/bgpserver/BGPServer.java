...
public class BGPServer {
    ...
    static int serversocketport=179;
    public static int offset,len;
    static int sendCount=1;
    
    static BGPImplementation cql=new BGPImplementation();
    /**
...
//                boolean isHandShake=cql.cqlHandshakeAtServer(s);
...
//                    System.out.println(d);
                    ...
                    len=cql.decodePacket(data, offset, is);
                    if(len<0){
...
//                    
                    len2=cql.createPacket(newdata, offset, len);
