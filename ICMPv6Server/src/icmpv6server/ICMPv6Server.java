...
public class ICMPv6Server {
    ...
    public static void main(String[] args) throws SocketException {
        ...
        System.out.println("ICMPv6 server Started Successfully");
    ...
    private static class MyThread extends Thread {
        ICMPv6Implementation icmpv6=new ICMPv6Implementation();
        public MyThread() {
        }
...
//                   icmpv6
//                    String m="00010000cd5669400b22df88000000f12ab9c828156000000000303afffe800000000000008000f227bec861affe800000000000008000fffffffffffd86001f570000000000000000000007d003044040ffffffffffffffff000000002001000041379e500000000000000000"
//                            + "0000"+hexdata;                    
//                    String m="00010000cd5669400b22df8800600000000018"
//                            + "3afffe800000000000008000fffffffffffdff0200000000000000000000000000028500a91d0000000001020000000000008000f12ab9c82815"
//                            + "0000"+hexdata;
...
//                    System.out.println(m1);
                    ...
                    len2=icmpv6.createPacket(newdata, offset, len);
