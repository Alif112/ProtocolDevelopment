...
public class IPAServer {
    ...
    static int serversocketport=5000;
    ...
    static class MyNewThread extends Thread {
        ...
        public void run() {
            try{
                ...
                boolean isHandShake=smtp.ipaHandshakeAtServer(s);
...
//                    System.out.println(d);
                    ...
                    len=smtp.decodePacketAtServer(data, offset, is);
                    if(len<0){
...
//                    
                    len2=smtp.createPacketAtServer(newdata, offset, len);
