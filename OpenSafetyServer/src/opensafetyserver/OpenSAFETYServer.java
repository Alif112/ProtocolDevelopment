...
public class OpenSAFETYServer {
    static int ServerPort=3819;
    ...
    public static void main(String[] args) throws SocketException {
        ...
        System.out.println("OpenSafety server Started Successfully");
    ...
    private static class MyThread extends Thread {
        OpenSAFETYImplementation icmpv6=new OpenSAFETYImplementation();
        public MyThread() {
        }
