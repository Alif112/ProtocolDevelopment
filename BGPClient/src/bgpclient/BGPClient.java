...
public class BGPClient {
    ...
    public static int clientport=179;
    ...
    static int chk;
    static BGPImplementation smtp=new BGPImplementation();
    ...
    static class MySender extends Thread {
        ...
        public void run() {
            ...
            try {
                InetAddress addr = InetAddress.getByName(ip);
                Socket socket=new Socket(ip,clientport);
//                boolean isHandShake=smtp.cqlHandshakeAtClient(socket);
...
//                    System.out.println(msg);
                    ...
                    len=smtp.decodePacket(data, offset, is);
    ...
    private static class MultiSender {
        ...
        public void init() {
            try {
                ...
                int countsend=0;
                byte[] message=new byte[2048];
//                boolean isHandShake=smtp.cqlHandshakeAtClient(skt);
//                if(!isHandShake) throw new Exception("HandShaking Failed!!!");
