...
public class AutoRPServer {
    static int ServerPort=496;
    ...
    public static void main(String[] args) throws SocketException {
        ...
        System.out.println("AutoRP server Started Successfully");
    ...
    private static class MyThread extends Thread {
        AutoRPImplementation xtacacs=new AutoRPImplementation();
        public MyThread() {
        }
