...
public class OpenSAFETYClient {
    static int clientToServerPort=3819;
    static int numberOfPackets=3;
    static int totalSend=0;
    static int totalReceive=0;
    static long receiverTime=(long) 1e9;
    
    static OpenSAFETYImplementation icmpv6=new OpenSAFETYImplementation();
