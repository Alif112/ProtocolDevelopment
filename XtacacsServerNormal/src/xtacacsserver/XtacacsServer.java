...
public class XtacacsServer {
    ...
    public static void main(String[] args) throws SocketException {
        ...
        System.out.println("CoAP server Started Successfully");
    ...
    private static class MyThread extends Thread {
        XTACACSImplementation dspv2=new XTACACSImplementation(false);
        public MyThread() {
        }
...
//                    System.out.println(m1);
                    ...
                    len2=dspv2.createPacket(newdata, offset, len,isend,portSend);
