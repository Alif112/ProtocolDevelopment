...
public class IPAImplementation {
    ...
    private String[] header_Type_String_Array={"ANNOUNCE", "SETUP", "RECORD", "PAUSE", 
        "FLUSH", "TEARDOWN", "OPTIONS", "GET_PARAMETER", "SET_PARAMETER"};
    private int packetController;
    private byte[] headerBuilder,first_Header_link,last_Header_Link;
    private byte[] firstHeaderHand,secondHeaderHand,thirdHeaderHand;
...
//            System.out.println("------------------------> "+index);
            ...
            os.write(Utility.hexStringToByteArray(""));
    ...
    public int createPacketAtClient(byte [] data, int offset, int len){
        ...
        index=headerEqualizer(data,index,13-headerBuilder.length);
        data[index++]=0x0d; data[index++]=0x0a;
    ...
    private int headerEqualizer(byte[] data, int offset, int number) {
        int index=offset;
        for(int i=0;i<number;i++)
