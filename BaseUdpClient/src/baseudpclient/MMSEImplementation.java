...
//        copy of uri
        String uri="687474703a2f2f6d6d7363656e7465722e73756e63656c6c756c61722e636f6d2e70682f";
        byte[] uriData=Utility.hexStringToByteArray(uri);
        System.arraycopy(uriData, 0, data, index, uriData.length);
        index+=uriData.length;
        
//        content copy
        String content="61707000";
        byte[] contentData=Utility.hexStringToByteArray(content);
        System.arraycopy(contentData, 0, data, index, contentData.length);
        index+=contentData.length;
        
//        copy mmse
        String mmse="8c839841354a446c697547653877516b38505a77008d9095819180";
        byte[] mmseData=Utility.hexStringToByteArray(mmse);
